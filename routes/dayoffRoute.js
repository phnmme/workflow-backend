...
router.post("/:requestID/cancelRequest",requireUser,dayoffController.cancelRequest)

router.post("/addLeaveType",requireAdmin,adminDayoffController.addLeaveType)
router.patch("/:requestID/changeStatus",requireAdmin,adminDayoffController.changeStatus)
router.patch("/:leaveTypeID/updateLeaveType",requireAdmin,adminDayoffController.updateLeaveType)
